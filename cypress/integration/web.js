describe('Fill web form', () => { 
    before(() => {
        ...
        cy.get('.pp-new-public-form-left-aside') 
          .should('be.visible')
    })
    ...
    it('Fill name', () => {
        cy.get('[name="customFields.your_name"]')
         .type('Beatriz Negrao')
         .should('have.value', 'Beatriz Negrao')
    })
    
    it('Fill why I want to work at Pipefy', () => { 
        cy.get('[name="customFields.why_do_you_want_to_work_at_pipefy"]')
          .type('I want to work at Pipefy because it is super fun!')
          .should('have.value', 'I want to work at Pipefy because it is super fun!') 
    })
    
    it('Select B option on checkbox', () => { 
    ...
    it('Select user', () => {
        ...
        cy.get('.pp-item-list a[title="felipe fantoni"]')
          .click()
    ...
    it('Select today`s date on Datepicker', () => {
        // Open date picker
    ...
    it('Select B option on dropdown menu', () => { 
    ...
    it('Place a phone number from Spain country', () => {
